...
function createFooter() {
  ...
  (0,_helpers_helpSetAttr_js__WEBPACK_IMPORTED_MODULE_0__["default"])(anchor, { href: "", target: "_blank" });
  const linkPara = document.createElement("p");
  linkPara.innerHTML = "Copyright &copy; 2023 Joey Young";
  anchor.appendChild(linkPara);

  const anchor2 = document.createElement("a");
  (0,_helpers_helpSetAttr_js__WEBPACK_IMPORTED_MODULE_0__["default"])(anchor2, { href: "", target: "_blank" });
